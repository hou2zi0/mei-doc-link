...
function teiDocLinks() {
  ...
  function elementReplacer(match, p1, p2, p3, p4, offset, string) {
    ...
    return `<span class='delimiters'>&lt;${frontDelimiters}</span><span class='element'><a class='tei-doc-link' href='https://music-encoding.org/guidelines/v4/elements/${element.toLowerCase()}.html'>${element}</a>${newSnippetAttr}</span><span class='delimiters'>${backDelimiter}&gt;</span>`;
  }
